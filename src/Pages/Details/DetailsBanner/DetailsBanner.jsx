...
import Img from "../../../Components/lazyLoadingComponents/LazyLoadImg.jsx";
...
const DetailsBanner = ({ video, crew }) => {
    ...
    const toHoursAndMinutes = (totalMinutes) => {
        // converting total minutes of movie into hrs
        ...
        <div className="detailsBanner">
            {!loading ? (
                <>
                    {data &&
                        <div>
                            <Img className="backdrop-img" src={url.backdrop + data?.backdrop_path} />
